...
```{python}
adata_norm.uns["liana_res"].to_csv("pvn_astro-with_npy_pomc-liana-res-cellchatdb.csv")
...
n2a_norm.save(
    filename="liana-dotplot-logfc-normal-conditions-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_norm.save(
    filename="liana-dotplot-specificity_rank-normal-conditions-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_norm.save(
    filename="liana-dotplot-magnitude_rank-normal-conditions-n2a-insr-status-cellchatdb.pdf"
)
```
...
a2n_norm.save(
    filename="liana-dotplot-logfc-normal-conditions-a2n-insr-status-cellchatdb.pdf"
)
```
...
a2n_norm.save(
    filename="liana-dotplot-specificity_rank-normal-conditions-a2n-insr-status-cellchatdb.pdf"
)
```
...
a2n_norm.save(
    filename="liana-dotplot-magnitude_rank-normal-conditions-a2n-insr-status-cellchatdb.pdf"
)
```
...
n2a_chronic_stress.save(
    filename="liana-dotplot-logfc-chronic-stress-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_chronic_stress.save(
    filename="liana-dotplot-specificity_rank-chronic-stress-n2a-insr-status-cellchatdb.pdf"
)
```
...
n2a_chronic_stress.save(
    filename="liana-dotplot-magnitude_rank-chronic-stress-n2a-insr-status-cellchatdb.pdf"
)
```
...
a2n_chronic_stress.save(
    filename="liana-dotplot-logfc-chronic-stress-a2n-insr-status-cellchatdb.pdf"
)
```
...
a2n_chronic_stress.save(
    filename="liana-dotplot-specificity_rank-chronic-stress-a2n-insr-status-cellchatdb.pdf"
)
```
...
a2n_chronic_stress.save(
    filename="liana-dotplot-magnitude_rank-chronic-stress-a2n-insr-status-cellchatdb.pdf"
)
```
