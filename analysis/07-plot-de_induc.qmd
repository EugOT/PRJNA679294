---
title: "Differential expression analysis of Paraventricular nucleus astrocytes dataset from Lopez JP et al 2021"
...
DOCNAME <- "de-astrocytes-between-conditions-astrocytes-dataset-from-lopez2021"
NOW <- Sys.time()
...
```{r plt-stvlnplot-at_genes-mitochondrial, fig.width=4, fig.height=32}
...
```{r plt-vln, fig.width=6, fig.height=7}
...
```{r plt-sds-non-induc, fig.width=10, fig.height=8}
plt_genes_const %>%
  ggplot(
    .,
    aes(
